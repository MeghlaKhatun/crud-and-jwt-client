            ...
            <div className="max-w-7xl mx-auto">
                <form>
                    ...
                    <div className="flex justify-center md:justify-start mt-4">
                        <input type="submit" value="Submit" className="bg-[#009866] border-none text-white py-2 outline-none md:py-3 px-4 text-center md:px-8 font-semibold cursor-pointer"/>
                    </div>
                </form>
            </div>
